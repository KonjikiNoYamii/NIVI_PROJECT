...
const DashboardPengajar = () => {
  ...
  const getAbsensiStats = () => {
    ...
    const presentPercentage =
      total > 0 ? (data.absensi.hadir / total) * 100 : 0;
    ...
    <SafeAreaView style={styles.safe}>
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerSubtitle}>Ringkasan aktivitas terbaru</Text>
        </View>
          ...
          <View style={styles.progressContainer}>
            ...
            <Text style={styles.progressText}>
              <Text style={styles.progressPercent}>
                {absensiStats.presentPercentage.toFixed(1)}%
              </Text>{' '}
              Kehadiran
            </Text>
          </View>
        ...
        <View style={styles.card}>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.8}
            onPress={() => navigation.navigate('ManageIzinSantri')}
          >
            <View
              style={[
            ...
            <View style={styles.actionContent}>
              ...
              <Text style={styles.actionSubtitle}>
                Tinjau permintaan izin dari santri
              </Text>
            </View>
